...
((SELECT id FROM employee WHERE first_name = 'Micheal' AND last_name = 'Fen'), (SELECT id FROM project WHERE title = 'The Robinson Project'), '2020-12-05'),
((SELECT id FROM employee WHERE first_name = 'Abdul' AND last_name = 'Rehmna'), (SELECT id FROM project WHERE title = 'Diamond'), '2021-1-1');
